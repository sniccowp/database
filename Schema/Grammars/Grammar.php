...
abstract class Grammar extends BaseGrammar
{
     ...
     * @return array
     */
    public function compileRenameColumn(Blueprint $blueprint, Fluent $command, ConnectionInterface $connection)
    {
     ...
     */
    public function compileChange(Blueprint $blueprint, Fluent $command, ConnectionInterface $connection)
    {
